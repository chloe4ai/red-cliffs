...
export const CAST = {
  'cao-cao': {
    zh: '曹　操', en: 'CAO CAO', roleZh: '漢丞相 · 魏武帝', roleEn: 'Chancellor of Han',
    file: 'cao-cao.jpg', face: [0.16, 0.13, 0.66, 0.52],
    source: '王圻《三才圖會》c.1607',
  },
  'zhuge-liang': {
    zh: '諸葛亮', en: 'ZHUGE LIANG', roleZh: '軍師中郎將 · 蜀', roleEn: 'Strategist of Shu',
    file: 'zhuge-liang.jpg', face: [0.14, 0.16, 0.68, 0.50],
    source: '《三才圖會》萬曆三十七年 (1609)',
  },
  'zhou-yu': {
    zh: '周　瑜', en: 'ZHOU YU', roleZh: '大都督 · 吳', roleEn: 'Grand Commander of Wu',
    file: 'zhou-yu.jpg', face: [0.50, 0.13, 0.42, 0.28],
    source: '清代繡像本',
  },
  'huang-gai': {
    zh: '黃　蓋', en: 'HUANG GAI', roleZh: '將軍 · 吳', roleEn: 'General of Wu',
    file: 'huang-gai.jpg', face: [0.26, 0.06, 0.50, 0.26],
    source: '清代繡像本',
  },
  'pang-tong': {
    zh: '龐　統', en: 'PANG TONG', roleZh: '謀士', roleEn: 'Adviser',
    file: 'pang-tong.jpg', face: [0.28, 0.07, 0.46, 0.26],
    source: '清代繡像本',
  },
};
